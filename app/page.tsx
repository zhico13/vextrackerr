...
import { TrendingUp, Zap, RefreshCw, AlertCircle, MessageCircle, Twitter } from "lucide-react"
...
export default function VexMemecoin() {
  ...
  const handleTelegramClick = () => {
    window.open(TOKEN_CONFIG.socialLinks.telegram, "_blank")
  }

  const handleTwitterClick = () => {
    window.open(TOKEN_CONFIG.socialLinks.twitter, "_blank")
  }

  const handleWebsiteClick = () => {
    if (TOKEN_CONFIG.socialLinks.website) {
      window.open(TOKEN_CONFIG.socialLinks.website, "_blank")
    }
  }
    ...
    <div className="min-h-screen bg-[#0a0f07] text-[#a8d5ba]">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden md:flex items-center gap-2">
                <Button
                  size="sm"
                  variant="ghost"
                  className="text-[#a8d5ba] hover:text-[#7efb74] hover:bg-[#2ddc58]/20 p-2"
      ...
      <section className="py-12 px-4 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 max-w-4xl">
          ...
          {/* Social Media Links - Mobile Visible */}
          <div className="flex justify-center gap-4 md:hidden">
            <Button
              variant="outline"
              size="sm"
              className="border-[#2ddc58] text-[#2ddc58] bg-transparent hover:bg-[#2ddc58]/20 hover:border-[#7efb74] hover:text-[#7efb74] pixel-font"
              onClick={handleTelegramClick}
            >
      ...
      {/* CTA Section - Updated with Social Links */}
