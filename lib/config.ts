...
export const TOKEN_CONFIG = {
  ...
  // Social Media Links - UPDATED WITH REAL LINKS
  socialLinks: {
    telegram: "https://t.me/vextracker", // ✅ Real Telegram group
    twitter: "https://x.com/vextracker", // ✅ Real Twitter account
    website: "https://vextracker.fun", // Optional - you can update this later
  },
}
